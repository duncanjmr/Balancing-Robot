...
void FreeSixIMU::init(int acc_addr, int gyro_addr, bool fastmode) {
  ...
  // disable internal pullups of the ATMEGA which Wire enable by default
    ...
    // Don't need to disable internal pull-ups; the Due runs at 3.3v!
  #else
    // deactivate internal pull-ups for twi
  ...
  // init ITG3200
  Serial.print("Initializing ITG3200... ");
  gyro.init(gyro_addr);
  Serial.print("Done!\n");

  Serial.print("Waiting a second for the gyro to settle... ");
  delay(1000);
  ...
  Serial.print("Done initializing sixDOF!\n");
}
